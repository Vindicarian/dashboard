...
SCHEDULER.every '30m', :first_in => 0 do |job|
  ...
  stadium_feed = StadiumRSSProcessor.new
  stadium_events = stadium_feed.getEvents
    ...
    send_event("google_calendar_#{cal_name}", {events: events, stadium_events: stadium_events})
    end
